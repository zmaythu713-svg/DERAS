                ...
                <form method="POST" action="{{ route('admin-users.store') }}">
                    ...
                    <div class="row mb-4">
                        <div class="col-md-6 mb-3 mb-md-0">
                            ...
                            <input type="text" name="name" class="form-control @error('name') is-invalid @enderror" value="{{ old('name') }}" placeholder="အမည် ထည့်သွင်းပါ" required data-validate="name" data-label="အမည်">
                            @error('name')
                    ...
                    <div class="row mb-4">
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="position-relative">
                                <input type="password" id="password" name="password" class="form-control @error('password') is-invalid @enderror" style="padding-right: 42px;" placeholder="စကားဝှက် ထည့်သွင်းပါ" required minlength="8" autocomplete="new-password">
                    ...
                    <div class="row mb-4">
                        <div class="col-md-6">
                            ...
                            <div class="position-relative">
                                <input type="password" id="password_confirmation" name="password_confirmation" class="form-control" style="padding-right: 42px;" placeholder="စကားဝှက် ပြန်လည်ရိုက်ထည့်ပါ" required minlength="8" data-match="password" autocomplete="new-password">
